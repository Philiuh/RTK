...
import { fetchUserToken, getError } from '../../../modules/authorization'
...
const LoginForm = ({ fetchUserToken, loginError }) => {
    ...
    <Wrapper colors={['transparent', 'transparent']}>
      <Container>
        ...
        <FormInput
          ...
          errorUnderline={error}
        />
        <ErrorText>{loginError ? loginError : error && error}</ErrorText>
